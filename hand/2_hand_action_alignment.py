...
def clean_nan_sequence(data_tensor):
    """
    Cleaning up NaN values in a tensor, using the forward padding method
    
    Args.
        data_tensor: input tensor, may contain NaN values
        
    Returns.
        Cleaned tensor with NaN values replaced with previous valid values
    """
